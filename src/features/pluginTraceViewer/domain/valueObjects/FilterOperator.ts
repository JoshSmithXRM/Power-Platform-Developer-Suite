...
export class FilterOperator {
	private constructor(
		...
		public readonly applicableTypes: readonly ('text' | 'enum' | 'date' | 'number')[]
	) {}

	// Text operators
	static readonly Equals = new FilterOperator('Equals', 'eq', ['text', 'enum', 'number']);
	...
	static readonly NotEquals = new FilterOperator('Not Equals', 'ne', ['text', 'enum', 'number']);
	...
	static forFieldType(fieldType: 'text' | 'enum' | 'date' | 'number'): FilterOperator[] {
