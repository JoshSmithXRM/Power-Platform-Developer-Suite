...
export class ToolsTreeProvider implements vscode.TreeDataProvider<ToolItem> {
	...
	getChildren(): ToolItem[] {
		return [
			...
			new ToolItem('Deployment Settings', 'Create, load, and promote deployment settings', 'deploymentSettings', 'power-platform-dev-suite.deploymentSettingsPromotion', 'rocket'),
