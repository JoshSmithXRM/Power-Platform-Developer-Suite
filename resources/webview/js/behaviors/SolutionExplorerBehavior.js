 ...
 * Handles client-side interactions for the Solution Explorer panel.
 */
...
function updateTableData(data) {
	...
	if (!tbody) {
		console.warn('[SolutionExplorer] No tbody found for table update');
		return;
	}
	...
	if (isLoading) {
		...
		window.TableRenderer.showTableLoading(tbody, 'Loading solutions...');
		return;
	}
