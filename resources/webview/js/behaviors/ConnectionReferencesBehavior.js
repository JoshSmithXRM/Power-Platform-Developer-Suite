/**
 * Connection References Behavior
 * Handles client-side interactions for the Connection References panel.
 */
 ...
 *
 * @param {Object} data - Update data containing viewModels, columns, noDataMessage, and optional isLoading flag
 */
function updateTableData(data) {
	...
	if (!tbody) {
		console.warn('[ConnectionReferences] No tbody found for table update');
		return;
	}
	...
	if (isLoading) {
		...
		window.TableRenderer.showTableLoading(tbody, 'Loading connection references...');
		return;
	}
